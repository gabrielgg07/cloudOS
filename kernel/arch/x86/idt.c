...
void idt_init() {
    ...
    set_idt_gate(32, (uint32_t)irq_stub_0);
    set_idt_gate(33, (uint32_t)irq_stub_1);
    set_idt_gate(34, (uint32_t)irq_stub_2);
    set_idt_gate(35, (uint32_t)irq_stub_3);
    set_idt_gate(36, (uint32_t)irq_stub_4);
    set_idt_gate(37, (uint32_t)irq_stub_5);
    set_idt_gate(38, (uint32_t)irq_stub_6);
    set_idt_gate(39, (uint32_t)irq_stub_7);
    set_idt_gate(40, (uint32_t)irq_stub_8);
    set_idt_gate(41, (uint32_t)irq_stub_9);
    set_idt_gate(42, (uint32_t)irq_stub_10);
    set_idt_gate(43, (uint32_t)irq_stub_11);
    set_idt_gate(44, (uint32_t)irq_stub_12);
